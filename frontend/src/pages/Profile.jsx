...
export default function Profile() {
    ...
    return (
        <div className='pt-16 md:pt-28 mt-6 min-h-screen bg-[#F8FAFC] text-slate-900 pb-24 md:pb-32'>
            <div className="max-w-5xl mx-auto px-4 sm:px-6">
                                <div className="bg-white rounded-[24px] md:rounded-[32px] p-5 md:p-8 mb-6 border border-slate-200/60 shadow-sm flex flex-col md:flex-row items-center gap-6 md:gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="mt-4 flex flex-wrap justify-center md:justify-start items-center gap-2 md:gap-3">
                            ...
                            {isAdmin && (
                                <NavLink
                                    to="/dashboard/sales"
                                    className="inline-flex items-center px-3 py-2 rounded-xl text-[10px] font-bold text-pink-600 bg-pink-50 border border-pink-100 hover:bg-pink-100 transition-colors"
                                >
                                    Admin Panel
                                </NavLink>
                            )}
                ...
                <Tabs defaultValue="profile" className="w-full">
                    <TabsList className="bg-slate-200/50 p-1 h-11 rounded-xl mb-6 w-full md:w-fit grid grid-cols-2 md:flex">
                        <TabsTrigger value="profile" className="rounded-lg px-4 md:px-8 py-2 data-[state=active]:bg-white data-[state=active]:text-slate-900 shadow-none data-[state=active]:shadow-sm transition-all font-bold text-xs md:text-sm text-slate-500">
                            Identity
                        </TabsTrigger>
                        <TabsTrigger value="orders" className="rounded-lg px-4 md:px-8 py-2 data-[state=active]:bg-white data-[state=active]:text-slate-900 shadow-none data-[state=active]:shadow-sm transition-all font-bold text-xs md:text-sm text-slate-500">
                            Orders
                        </TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="profile" className="outline-none animate-in fade-in slide-in-from-bottom-2">
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            <div className="bg-white p-6 md:p-8 rounded-[24px] md:rounded-[32px] border border-slate-200/60 shadow-sm space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <Input name='firstName' value={updateUser.firstName} onChange={handleChange} className="bg-slate-50 border-none h-11 md:h-12 rounded-xl focus-visible:ring-1 focus-visible:ring-slate-200 text-sm" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <Label className="text-[10px] font-bold text-slate-400 ml-1">Last Name</Label>
                                            <Input name='lastName' value={updateUser.lastName} onChange={handleChange} className="bg-slate-50 border-none h-11 md:h-12 rounded-xl focus-visible:ring-1 focus-visible:ring-slate-200 text-sm" />
                                        </div>
                                    </div>
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input disabled value={updateUser.email} className="pl-11 bg-slate-100 border-none h-11 md:h-12 rounded-xl opacity-60 text-sm" />
                                        </div>
                                    </div>
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input name='phoneNo' value={updateUser.phoneNo} onChange={handleChange} className="pl-11 bg-slate-50 border-none h-11 md:h-12 rounded-xl text-sm" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white p-6 md:p-8 rounded-[24px] md:rounded-[32px] border border-slate-200/60 shadow-sm space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <Input name='address' value={updateUser.address} onChange={handleChange} className="bg-slate-50 border-none h-11 md:h-12 rounded-xl text-sm" />
                                    </div>
                                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                                        <div className="space-y-1.5">
                                            <Label className="text-[10px] font-bold text-slate-400 ml-1">City</Label>
                                            <Input name='city' value={updateUser.city} onChange={handleChange} className="bg-slate-50 border-none h-11 md:h-12 rounded-xl text-sm" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <Label className="text-[10px] font-bold text-slate-400 ml-1">Zip Code</Label>
                                            <Input name='zipCode' value={updateUser.zipCode} onChange={handleChange} className="bg-slate-50 border-none h-11 md:h-12 rounded-xl text-sm" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mt-8 sticky bottom-4 md:static md:mt-10 rounded-2xl bg-white/90 backdrop-blur-md border border-slate-200 p-3 md:p-4 z-40 shadow-xl md:shadow-[0_-10px_20px_rgba(0,0,0,0.02)]">
                            <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-2 w-full sm:w-auto">
                                    <Button
                                        variant="ghost"
                                        className="flex-1 sm:flex-none rounded-xl font-bold text-slate-500 text-xs"
